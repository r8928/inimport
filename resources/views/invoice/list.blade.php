<x-layout title="Invoices">
    ...
    <div class="d-flex justify-content-between mb-3" style="gap:10px">
        ...
        <span>
            ...
            <a href="{{ route('config.index') }}" class="btn btn-outline-primary" type="button">⚙ Config</a>
            <a href="{{ route('logout') }}" class="btn btn-outline-primary" type="button">🔑 Logout</a>
        </span>
    </div>
            ...
            @foreach ($data as $item)
                <tr>
                    ...
                    <td align="center"><a class="btn btn-outline-primary"
                            href="{{ route('invoice.send', $item->invoice_no) }}"><img
